...
contract LooksRareTypeHashes {
    ...
    bytes32 public constant DOMAIN_SEPARATOR = keccak256(
        abi.encode(
            0x8b73c3c69bb8fe3d512ecc4cf759cc79239f7b179b0ffacaa9a75d522b39400f, // keccak256("EIP712Domain(string
            ...
            0xc89efdaa54c0f20c7adf612882df0950f5a951637e0307cdcb4c672f298b8bc6, // keccak256(bytes("1"))
                // for versionId = 1
            1,
            0x59728544B08AB483533076417FbBB2fD0B17CE3a // mainnet LooksRare
                // exchange address
        )
    );
