...
contract LooksRareV2Config is BaseMarketConfig, LooksRareV2TypeHashes {
    ...
    address internal constant OWNER = 0xBfb6669Ef4C4c71ae6E722526B1B8d7d9ff9a019;
    ...
    {
        takerOrder =
            OrderStructs.Taker({ recipient: taker, additionalParameters: "" });
    }
    ...
    function beforeAllPrepareMarketplace(address, address) external override {
        ...
        buyerErc1155ApprovalTarget =
            sellerErc1155ApprovalTarget = TRANSFER_MANAGER;
        buyerErc20ApprovalTarget =
            sellerErc20ApprovalTarget = address(LOOKS_RARE);
    }
    ...
    function beforeAllPrepareMarketplaceCall(
        ...
        SetupCall[] memory setupCalls = new SetupCall[](currenciesLength + 3);
        ...
        setupCalls[currenciesLength] = SetupCall(
            ...
            TRANSFER_MANAGER,
            abi.encodeWithSelector(
                ITransferManager.grantApprovals.selector, operators
            )
        );
        ...
        setupCalls[currenciesLength + 2] = SetupCall(
            cast.sidecar,
            TRANSFER_MANAGER,
            abi.encodeWithSelector(
                ITransferManager.grantApprovals.selector, operators
    ...
    function getPayload_BuyOfferedManyERC721WithEtherDistinctOrders(
        ...
        ManyItemsCalldataParams memory params =
            buildManyItemsCalldataParams(contexts.length);
